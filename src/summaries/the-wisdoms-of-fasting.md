  ...
  <div class="space-y-16 font-light leading-relaxed">
    ...
    <section class="reveal-on-scroll">
      <div class="bg-[#24211e] border-l-2 border-[#d6b278] p-6 sm:p-8 rounded-r-lg space-y-4">
        ...
        <p class="text-base text-[#B3ADB9] border-t border-[#332f2b] pt-3">
          Our human ignorance of the deeper secrets behind certain acts of worship does not signify an absence of divine wisdom; rather, it reflects the inherent limits of human understanding.
        </p>
        <span class="text-xs font-mono text-[#d6b278] uppercase block tracking-wider">
          “And you have not been given of knowledge except a little.” — Sūrah al-Isrā’ [17:85]
        </span>
      </div>
    </section>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        Divine legislation functions as a deliberate test to distinguish the truthful servant who worships Allah sincerely from the individual who remains enslaved to personal desires.
      </p>

      <p class="text-lg sm:text-xl text-[#B3ADB9]">
        In fasting, the believer willingly abandons essential, naturally beloved drives—food, drink, and intimate physical relations—solely for the sake of the Creator. Through this voluntary abstinence, the genuine depth of faith, absolute servitude, and love for Allah are made manifest.
      </p>
      ...
      <div class="bg-[#1c1a18] p-6 rounded-lg border border-[#332f2b] space-y-2">
        <h3 class="text-xl font-medium text-white">Tranquility in Sacred Sacrifice</h3>
        <p class="text-base text-[#B3ADB9]">
          When the believer recognizes that divine pleasure lies in abstaining from natural pleasures, giving preference to the Lord's delight over personal desire becomes a source of profound joy, peace, and spiritual fulfillment.
        </p>
      </div>
    </section>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        Fasting is fundamentally designed as a spiritual shield to produce piety (<e>Taqwā</e>) within the believer's consciousness, regulating both physical impulses and moral conduct.
      </p>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        Unchecked indulgence hardens the heart and dulls spiritual perception. By intentionally subduing bodily desires, fasting clears the mind and restores sensitivity to divine truth.
      </p>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        Beyond its spiritual dimensions, fasting imparts rigorous discipline, fortifies internal defenses against demonic influence, and promotes physical well-being.
      </p>
      ...
      <div class="bg-[#24211e] p-6 sm:p-8 rounded-lg border border-[#24211e] space-y-6">
        ...
        <div class="flex items-start gap-4">
          ...
          <div class="space-y-1">
            <h3 class="text-lg font-medium text-white sm:text-xl">Training the Lower Soul</h3>
            <p class="text-base text-[#B3ADB9]">
              The human ego naturally inclines toward excess unless governed. Leaving the soul unbridled causes perishing; training it through self-control directs it toward the highest moral ranks.
            </p>
          </div>
        </div>
        ...
        <div class="flex items-start gap-4 border-t border-[#332f2b] pt-6">
          ...
          <div class="space-y-1">
            <h3 class="text-lg font-medium text-white sm:text-xl">Constricting Spiritual Evil</h3>
            <p class="text-base text-[#B3ADB9]">
              Hunger and thirst constrict the blood vessels, effectively narrowing the pathways through which Satanic whispers (<e>Waswās</e>) attempt to influence the human body.
            </p>
          </div>
        </div>
        ...
        <div class="flex items-start gap-4 border-t border-[#332f2b] pt-6">
          ...
          <div class="space-y-1">
            <h3 class="text-lg font-medium text-white sm:text-xl">Physical Renewal and Health</h3>
            <p class="text-base text-[#B3ADB9]">
              Minimizing food intake affords the digestive system a vital period of rest, reducing excess moisture, clearing harmful accumulated waste, and renewing bodily balance.
            </p>
          </div>
        </div>
