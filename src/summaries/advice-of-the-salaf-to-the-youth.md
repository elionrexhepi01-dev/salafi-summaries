  ...
  <div class="space-y-16 font-light leading-relaxed">
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        The phase of youth is an irreplaceable juncture in human life. It represents a unique convergence of physical strength, mental acuity, sharpness of the senses, and active energy—qualities that inevitably diminish as old age approaches.
      </p>

      <p class="text-lg sm:text-xl text-[#B3ADB9]">
        Because youth is the golden era of human potential, it carries a weightier accountability before the Creator. The early righteous scholars (<e>al-Salaf al-Ṣāliḥ</e>) continuously emphasized that how one spends these foundational years determines their ultimate standing in both realms.
      </p>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div class="bg-[#1c1a18] p-6 rounded-lg border border-[#332f2b] space-y-3">
          <span class="text-xs font-mono uppercase tracking-widest text-[#d6b278]">Eschatological Audit</span>
          <h3 class="text-xl font-medium text-white">Accountability for Youth</h3>
          <p class="text-base text-[#B3ADB9] italic">
            “The feet of the son of Adam will not move on the Day of Judgment until he is questioned about five matters: about his life and how he used it, his youth and how he spent it...”
          </p>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        The Companion generation and those who followed them viewed young seekers of knowledge not as mere novices, but as the living custodians of the Prophetic inheritance. They welcomed youth into their gatherings with immense warmth and elevated their resolve.
      </p>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div class="bg-[#1c1a18] p-6 rounded-lg border border-[#332f2b] space-y-3">
          <span class="text-xs font-mono uppercase tracking-widest text-[#d6b278]">Prophetic Legacy</span>
          <h3 class="text-xl font-medium text-white">Welcoming the Successors</h3>
      ...
      <div class="bg-[#24211e] border-l-2 border-[#d6b278] p-6 sm:p-8 rounded-r-lg space-y-3">
        <span class="text-xs font-mono uppercase tracking-widest text-[#d6b278]">Mentorship & Certainty</span>
        <p class="text-lg sm:text-xl text-[#ECE8EF] italic">
          “O my nephew, if you ever have doubt about something, then ask me until you are certain. For certainly, you leaving upon certainty is more beloved to me than you leaving upon doubt.”
        </p>
        <span class="text-xs font-mono text-[#d6b278] uppercase block">— Abū Sa‘īd al-Khudrī <span class="text-[#B3ADB9]">رَضِيَ ٱللَّٰهُ عَنْهُ</span></span>
      </div>
    </section>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        The scholars of the Salaf did not treat spiritual pursuit as an abstract ideal; they coupled intense personal worship with financial self-sufficiency, practical skill, and an unwavering focus on the Hereafter.
      </p>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div class="bg-[#1c1a18] p-6 rounded-lg border border-[#332f2b] space-y-3">
          <span class="text-xs font-mono uppercase tracking-widest text-[#d6b278]">Spiritual Stamina</span>
          <h3 class="text-xl font-medium text-white">Vigor in Worship</h3>
          <p class="text-base text-[#B3ADB9]">
      ...
      <div class="bg-[#24211e] p-6 sm:p-8 rounded-lg border border-[#24211e] space-y-3">
        ...
        <h3 class="text-xl font-medium text-white">Seeking the Hereafter vs. Dunyā</h3>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        The most subtle disease threatening youth energy is <e>Tasweef</e>—the continual deferral of righteous action through empty promises of future effort.
      </p>
      ...
      <div class="bg-[#24211e] p-6 sm:p-8 rounded-lg border border-[#24211e] space-y-6">
        ...
        <div class="flex items-start gap-4">
          ...
          <div class="space-y-1">
            <h3 class="text-lg font-medium text-white sm:text-xl">Recognize the Delusion of "Soon"</h3>
            <p class="text-base text-[#B3ADB9]">
              Overcome the psychological trap of relying on tomorrow. Tomorrow's capacity is rarely greater than today's vigor.
            </p>
          </div>
        </div>
        ...
        <div class="flex items-start gap-4 border-t border-[#332f2b] pt-6">
          ...
          <div class="space-y-1">
            <h3 class="text-lg font-medium text-white sm:text-xl">Direct Energy Immediately</h3>
            <p class="text-base text-[#B3ADB9]">
              As Maymūn ibn Mihrān <span class="text-[#B3ADB9]">رَحِمَهُ ٱللَّٰهُ</span> exhorted those around him: <e>“O young people, use your energy and youth in obedience to Allah. O assembly of elders, up until when?”</e>
            </p>
          </div>
        </div>
      ...
      <!-- Warning Quote Card -->
      <div class="bg-[#24211e] border-l-2 border-[#d6b278] p-6 sm:p-8 rounded-r-lg space-y-3">
        <span class="text-xs font-mono uppercase tracking-widest text-[#d6b278]">Warning Against Tasweef</span>
        <p class="text-lg sm:text-xl text-[#ECE8EF] italic">
          “O young people, I warn you of procrastination, saying: ‘Soon I am going to do this, and soon I am going to do that.’”
        </p>
        <span class="text-xs font-mono text-[#d6b278] uppercase block">— al-Ḥasan al-Baṣrī <span class="text-[#B3ADB9]">رَحِمَهُ ٱللَّٰهُ</span></span>
      </div>
    </section>
