  ...
  <div class="space-y-16 font-light leading-relaxed">
    ...
    <section class="reveal-on-scroll">
      <div class="bg-[#24211e] border-l-2 border-[#d6b278] p-6 sm:p-8 rounded-r-lg space-y-4">
        ...
        <p class="text-sm text-[#d6b278] uppercase tracking-wider font-mono">
          — Sūrah an-Nisā’ [Qur'an 4:113]
        </p>
        <p class="text-base text-[#B3ADB9] pt-2 border-t border-[#332f2b]">
          A consensus of classical scholars clarifies that <e>al-Ḥikmah</e> in this divine revelation refers specifically to the legal ways, guidance, and Sunnah of the Prophet Muḥammad ﷺ.
        </p>
      </div>
    </section>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        Adherence to the Sunnah is not an optional spiritual devotion; it is an obligatory pillar of Islamic faith explicitly mandated across the Quranic text. To obey the Messenger is to obey Allah, and to abandon his guidance is to risk spiritual ruin.
      </p>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div class="bg-[#1c1a18] p-6 rounded-lg border border-[#332f2b] space-y-3">
          <span class="text-xs font-mono uppercase tracking-widest text-[#d6b278]">Command to Obey</span>
          <h3 class="text-xl font-medium text-white">Dual Obedience</h3>
        ...
        <div class="bg-[#1c1a18] p-6 rounded-lg border border-[#332f2b] space-y-3">
          ...
          <p class="text-base text-[#B3ADB9] italic">
            “And whosoever disobeys Allah and His Messenger, then verily, for him is the Fire of Hell...”
          </p>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        The Prophet ﷺ foresaw tendencies to detach the Quran from its prophetic explanation, issuing stern warnings against dismissing his Sunnah. He affirmed that the legal authority granted to him by Allah stands alongside the Quran itself.
      </p>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        Sticking to the purified Sunnah yields tangible fruits in the believer's inner heart and outward conduct. It converts mechanical physical actions into profound acts of spiritual connection and brings emotional stability to the soul.
      </p>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div class="bg-[#1c1a18] p-6 rounded-lg border border-[#332f2b] space-y-3">
          <span class="text-xs font-mono uppercase tracking-widest text-[#d6b278]">Effect 01</span>
          <h3 class="text-xl font-medium text-white">Presence of Heart in Worship</h3>
    ...
    <section class="space-y-6 reveal-on-scroll">
      ...
      <p class="text-lg sm:text-xl text-[#ECE8EF]">
        Genuine adherence requires a balanced commitment: actively performing what the Prophet ﷺ practiced and consciously avoiding what he deliberately refrained from in matters of religion.
      </p>
      ...
      <div class="bg-[#24211e] p-6 sm:p-8 rounded-lg border border-[#24211e] space-y-6">
        ...
        <div class="flex items-start gap-4">
          ...
          <div class="space-y-1">
            <h3 class="text-lg font-medium text-white sm:text-xl">Affirmative & Prohibitive Compliance</h3>
            <p class="text-base text-[#B3ADB9]">
              To follow the Sunnah is to accept it in its entirety—doing what was legislated and refraining from what was omitted. Ignoring or adding to these boundaries constitutes a shortfall in adherence.
            </p>
          </div>
        </div>
        ...
        <div class="flex items-start gap-4 border-t border-[#332f2b] pt-6">
          ...
          <div class="space-y-1">
            <h3 class="text-lg font-medium text-white sm:text-xl">The Peril of Religious Innovation (<e>Bid‘ah</e>)</h3>
            <p class="text-base text-[#B3ADB9]">
              Innovating in Islam is exceptionally dangerous because it implicitly presumes to decree acts of worship that Allah and His Messenger never legislated, infringing upon divine lawgiver rights.
            </p>
          </div>
        </div>
